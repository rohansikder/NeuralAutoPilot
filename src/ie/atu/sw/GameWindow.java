...
public class GameWindow implements KeyListener{
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_S) {
	        view.toggleDataCollection(); // Toggle data collection in the GameView
	        return;
	    }
		
		/*
		 * if (e.getKeyCode() == KeyEvent.VK_S) { //Press "S" to restart view.reset();
		 * //Reset the view and bail out return; }
		 */
